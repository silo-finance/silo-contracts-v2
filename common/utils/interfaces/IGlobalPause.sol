...
interface IGlobalPause {
    ...
    event OwnershipTransferStarted(address _contract, address _newOwner);
    event ContractAdded(address _contract);
    event ContractRemoved(address _contract);
    event OwnershipTransferred(address _contract, address _newOwner);
    ...
    function transferOwnership(address _contract, address _newOwner) external;
