...
FOUNDRY_PROFILE=ve-silo-test \
    forge script ve-silo/test/_mocks/for-testnet-deployments/milo-scripts/SendEthToProposer.sol \
    --ffi --broadcast --rpc-url http://127.0.0.1:8545
 */
contract SendEthToProposer is Script {
    function run() external {
        ...
        payable(proposer).transfer(0.001 ether);
