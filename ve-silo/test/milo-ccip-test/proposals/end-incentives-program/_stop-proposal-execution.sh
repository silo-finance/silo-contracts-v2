...
FOUNDRY_PROFILE=ve-silo-test \
    PROPOSAL_ID=43623163889929113804151205696156383502831327433539848154190946756488792824286 \
...
# Queue proposal
FOUNDRY_PROFILE=ve-silo-test \
    forge script ve-silo/test/milo-ccip-test/proposals/end-incentives-program/QueueStopMiningProposal.sol \
    --ffi --broadcast --rpc-url http://127.0.0.1:8545
...
# Execute proposal
FOUNDRY_PROFILE=ve-silo-test \
    forge script ve-silo/test/milo-ccip-test/proposals/end-incentives-program/ExecuteStopMiningProposal.sol \
    --ffi --broadcast --rpc-url http://127.0.0.1:8545
