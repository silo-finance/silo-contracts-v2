...
import {ERC20NoEvents} from "./erc-20-without-events/ERC20NoEvents.sol";
import {ER20PermitNoEvents} from "./erc-20-without-events/ER20PermitNoEvents.sol";
...
abstract contract ShareTokenNoEvents is Initializable, ER20PermitNoEvents, IShareToken {
    ...
    constructor() ERC20NoEvents(_NAME, _NAME) ER20PermitNoEvents(_NAME) {
    ...
    function permit(
        ...
        bytes32 r,
        bytes32 s
    ) public onlySilo override {
        ER20PermitNoEvents.permit(owner, spender, value, deadline, v, r, s);
    }

    /// @dev decimals of share token
    function decimals() public view virtual override(ERC20NoEvents, IERC20Metadata) returns (uint8) {
    ...
    function name()
        ...
        view
        virtual
        override(ERC20NoEvents, IERC20Metadata)
    ...
    /// @inheritdoc ERC20NoEvents
    function _update(address from, address to, uint256 value) internal virtual override {
        if (value == 0) revert ZeroTransfer();

        _beforeTokenTransfer(from, to, value);

        ERC20NoEvents._update(from, to, value);
