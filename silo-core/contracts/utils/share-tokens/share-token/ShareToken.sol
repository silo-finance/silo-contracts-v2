...
import {SiloERC20Permit, SiloERC20} from "../silo-erc-20/SiloERC20Permit.sol";
...
abstract contract ShareToken is Initializable, SiloERC20Permit, IShareToken {
    ...
    string private constant _SYMBOL = "SiloShareToken";
    ...
    constructor(bool _isSiloVaultToken) SiloERC20(_NAME, _SYMBOL, _isSiloVaultToken) SiloERC20Permit(_NAME) {
