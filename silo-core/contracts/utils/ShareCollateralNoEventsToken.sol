...
import {IShareToken, ShareTokenNoEvents, ISilo} from "./ShareTokenNoEvents.sol";

/// @title ShareCollateralNoEventsToken
/// @notice ERC20 compatible token representing collateral in Silo
/// @custom:security-contact security@silo.finance
contract ShareCollateralNoEventsToken is ShareTokenNoEvents {
    ...
    function _afterTokenTransfer(address _sender, address _recipient, uint256 _amount) internal virtual override {
        ...
        ShareTokenNoEvents._afterTokenTransfer(_sender, _recipient, _amount);
    }
