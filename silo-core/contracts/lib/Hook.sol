...
library Hook {
    ...
    uint256 internal constant SHARE_TRANSFER = 2 ** 10;
    ...
    uint256 internal constant LEVERAGE = 2 ** 14;

    uint256 internal constant BEFORE_DEPOSIT = 2 ** 3 | 2 ** 5;
    uint256 internal constant AFTER_DEPOSIT = 2 ** 4 | 2 ** 5;
    uint256 internal constant BEFORE_BORROW_SAME_ASSET = 2 ** 3 | 2 ** 6 | 2 ** 1;
    uint256 internal constant BEFORE_BORROW_TWO_ASSETS = 2 ** 3 | 2 ** 6 | 2 ** 2;
    uint256 internal constant AFTER_BORROW_SAME_ASSET = 2 ** 4 | 2 ** 6 | 2 ** 1;
    uint256 internal constant AFTER_BORROW_TWO_ASSETS = 2 ** 4 | 2 ** 6 | 2 ** 2;
