...
library SiloSolvencyLib2 {
    ...
    function isSolvent(
        ISiloConfig.CollateralConfig memory _collateralConfig,
        ISiloConfig.DebtConfig memory _debtConfig,
    ...
    function calculateLtv(
        SiloSolvencyLib2.LtvData memory _ltvData, address _collateralToken, address _debtToken)
        internal
        view
