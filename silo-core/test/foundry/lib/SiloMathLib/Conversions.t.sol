...
contract ConversionsTest is Test {
    ...
    */
    function test_SiloMathLib_conversions() public {
        ...
        uint256 shares = SiloMathLib.convertToShares(_assets, _totalAssets, _totalShares, _rounding, AssetTypes.Collateral);
        ...
        _assets = 1000;
        shares = SiloMathLib.convertToShares(_assets, _totalAssets, _totalShares, _rounding, AssetTypes.Collateral);
        ...
        _assets = SiloMathLib.convertToAssets(shares, _totalAssets, _totalShares, _rounding, AssetTypes.Collateral);
        assertEq(_assets, 1);
