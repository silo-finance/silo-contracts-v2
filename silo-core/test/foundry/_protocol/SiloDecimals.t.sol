...
contract SiloDecimalsTest is SiloLittleHelper, Test {
    ...
    */
    function test_decimals_6_18_noOracle() public {
        ...
        assertEq(collateral, 41_37817, "collateral");
        assertEq(debt, 39_40780, "debt");
    ...
    */
    function test_decimals_ETH_USDC_oracle() public {
        ...
        assertEq(silo0.maxWithdraw(borrower), 117647059200000000 - 1, "maxWithdraw (-1 underestimate for fractions)");
        _withdraw(silo0.maxWithdraw(borrower), borrower);
    ...
    */
    function test_decimals_HALF_USDC_oracle() public {
        ...
        assertEq(silo0.maxWithdraw(borrower), 117647 , "maxWithdraw (-1 underestimate for fractions)");
        _withdraw(silo0.maxWithdraw(borrower), borrower);
