...
contract BorrowSameAssetTest is SiloLittleHelper, Test {
    ...
    */
    ...
    //     vm.expectRevert(ISilo.AboveMaxLtv.selector);
    //     vm.prank(borrower);
    //     silo1.borrowSameAsset(borrowToMuch, borrower, borrower);
    ...
    //     assertTrue(silo1.borrowSameAssetPossible(borrower), "borrow is still possible, we just reached CAP");
    ...
    //     vm.prank(_borrower);
    //     shares = silo1.borrowSameAsset(_amount, _borrower, _borrower);
    // }
