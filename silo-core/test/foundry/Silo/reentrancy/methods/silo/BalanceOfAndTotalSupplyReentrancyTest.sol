...
contract BalanceOfAndTotalSupplyReentrancyTest is MethodReentrancyTest {
    ...
    function _ensureItWillNotRevert() internal view {
        SiloERC4626(address(TestStateLib.silo0())).balanceOfAndTotalSupply(address(this));
        SiloERC4626(address(TestStateLib.silo1())).balanceOfAndTotalSupply(address(this));
    }
}
