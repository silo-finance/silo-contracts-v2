...
contract AddNotificationReceiverReentrancyTest is MethodReentrancyTest {
    ...
    function methodDescription() external pure returns (string memory description) {
        description = "addNotificationReceiver(address,address)";
    }
    ...
    function _ensureItWillRevert() internal {
        ...
        IIncentiveHook(hookReceiver).addNotificationReceiver(
