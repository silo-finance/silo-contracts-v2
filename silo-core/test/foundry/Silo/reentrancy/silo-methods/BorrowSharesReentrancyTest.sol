...
contract BorrowSharesReentrancyTest is Test, IMethodReentrancyTest {
    function callMethod() external {
        ...
        vm.prank(borrower);
        silo0.borrowShares(borrowAmount, borrower, borrower, false /* same asset */);
    }
    ...
    function verifyReentrancy() external {
        ...
        vm.expectRevert(ISiloConfig.CrossReentrantCall.selector);
        silo1.borrowShares(1000, address(0), address(0), false);
    }
