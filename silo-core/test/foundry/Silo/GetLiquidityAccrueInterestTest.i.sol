...
contract GetLiquidityAccrueInterestTest is SiloLittleHelper, Test {
    ...
    */
    function test_liquidity_zero() public view {
        ...
        assertEq(silo1.getTotalStorage(AssetTypes.PROTECTED), 0, "no protected liquidity 1");
    }
    ...
    */
    function test_liquidity_whenDeposit(uint128 _assets) public {
        ...
        assertEq(silo0.getTotalStorage(AssetTypes.PROTECTED), _assets / 2, "[0] expect protected liquidity, no interest");

        assertEq(silo1.getLiquidity(), 0, "[1] no liquidity 1");
        assertEq(silo1.getLiquidity(), 0, "[1] no liquidity after deploy 1");
        assertEq(silo1.getTotalStorage(AssetTypes.PROTECTED), 0, "[1] no protected liquidity after deploy 1");
    }
    ...
    */
    function test_liquidity_whenProtected(uint256 _assets) public {
        ...
        assertEq(silo0.getTotalStorage(AssetTypes.PROTECTED), _assets, "[0] expect protected liquidity, no interest");
    ...
    */
    ...
    function _liquidity_whenDepositAndBorrow(uint128 _toDeposit, uint128 _toBorrow) private {
        ...
        assertEq(silo0.getTotalStorage(AssetTypes.PROTECTED), 0, "[0] no protected, no interest");
        ...
        assertEq(
            silo1.getTotalStorage(AssetTypes.PROTECTED),
            _toDeposit / 2,
    ...
    */
        ...
        private
    {
        ...
        uint256 silo1_protectedLiquidity = silo1.getTotalStorage(AssetTypes.PROTECTED);
    ...
    function _liquidity_whenDepositAndBorrowWithInterest_silo0(uint128 _toDeposit) private {
        ...
        uint256 silo0_protectedLiquidity = silo0.getTotalStorage(AssetTypes.PROTECTED);
        ...
        assertEq(
            ...
            silo0.getTotalStorage(AssetTypes.PROTECTED),
    ...
    function _getRawLiquidity(ISilo _silo) internal view returns (uint256) {
        return _silo.getTotalStorage(AssetTypes.COLLATERAL) - _silo.getTotalStorage(AssetTypes.DEBT);
    }
}
