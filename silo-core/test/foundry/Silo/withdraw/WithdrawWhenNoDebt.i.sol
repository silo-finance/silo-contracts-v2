...
contract WithdrawWhenNoDebtTest is SiloLittleHelper, Test {
    ...
    */
    function test_withdraw_all_Protected() public {
        ...
        assertEq(silo0.getTotalStorage(AssetTypes.PROTECTED), 0, "protected Assets should be withdrawn");
    }
    ...
    */
    function test_withdraw_scenario_manyUsers() public {
        ...
        assertEq(silo0.getTotalStorage(AssetTypes.PROTECTED), 11e18 + 1, "protected Assets should be withdrawn");
