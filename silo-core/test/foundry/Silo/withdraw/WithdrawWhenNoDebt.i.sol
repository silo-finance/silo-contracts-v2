...
contract WithdrawWhenNoDebtTest is SiloLittleHelper, Test {
    ...
    */
    function test_withdraw_all_Protected() public {
        ...
        assertEq(silo0.total(uint8(ISilo.AssetType.Protected)), 0, "protected Assets should be withdrawn");
    }
    ...
    */
    function test_withdraw_scenario_manyUsers() public {
        ...
        assertEq(silo0.total(uint8(ISilo.AssetType.Protected)), 11e18 + 1, "protected Assets should be withdrawn");
