...
contract InjectiveTest is Test {
    ...
    */
    function test_Injective_totalSupply() public {
        ...
        // user is one ot top holders
        emit log_named_uint("balance of MTS_USDT", IERC20(MTS_USDT).balanceOf(0x9fEbaf8A67ea584289f2538E5fF44218a15dA890));


        emit log_named_uint("totalSupply wINJ", IBankModule(BANK_PRECOMPILE).totalSupply(wINJ));

        emit log_named_uint("balance of wINJ", IERC20(wINJ).balanceOf(0xF3D10F5798E726e83ba6d7aEFD7841B8A112a098));
    }    
}