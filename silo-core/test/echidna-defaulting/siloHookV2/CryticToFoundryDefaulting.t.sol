...
contract CryticToFoundryDefaulting is Invariants, DefaultingHandler, SetupDefaulting {
    ...
    */
    function test_EchidnaDefaulting_test1() public {
        ...
        _delay(0x54aa4, 0xebab);
        _setUpActor(USER2);
        Target.assert_SILO_HSPOST_D(127);
        _delay(0x75, 0xdd0);
        _setUpActor(USER1);
        ...
        _delay(0x5bd20, 0x753b);
        _setUpActor(USER3);
        Target.setDaoFee(1524785993, 142349425366454869891183583699108563036);
        ...
        _delay(0x62e05, 0xd1ae);
        _setUpActor(USER2);
        Target.withdrawFees(255);
        ...
        _setUpActor(USER3);
        Target.MIN_PRICE();
        _delay(0x6a9f7, 0x5caa);
        _setUpActor(USER3);
        Target.setDaoFee(4370000, 4369999);
        _delay(0x7f7c2, 0xff);
        _setUpActor(USER2);
        ...
        _delay(0x24b01, 0x231);
        _setUpActor(USER3);
        Target.setDaoFee(340282366920938463463374607431768211453, 1524785993);
        ...
        _delay(0x5bd20, 0x8f87);
        _setUpActor(USER3);
        Target.withdrawFees(255);
        _delay(0x37272, 0x5ef7);
        _setUpActor(USER2);
        Target.withdrawFees(255);
        _delay(0xff, 0x5caa);
        _setUpActor(USER2);
        Target.withdrawFees(111);
        _delay(0x1ae49, 0x5c65);
        _setUpActor(USER3);
        Target.assert_LENDING_INVARIANT_B(255, 156);
        _delay(0x3e1ce, 0xd1ae);
        _setUpActor(USER2);
        Target.flashLoan(
            115792089237316195423570985008687907853269984665640564039457584007913129639934,
            81056000941499040701568388718779561639595820402536415116979475732076940173524,
            173,
            255
        );
        _delay(0x75d98, 0x7f);
        ...
        _delay(0x48a23, 0x2e32);
        _setUpActor(USER2);
        Target.assert_SILO_HSPOST_D(174);
        ...
        _delay(0x68584, 0xb31c);
        _setUpActor(USER1);
        Target.setDaoFee(125703671963345071573195876695721994215, 262991529744827556484540720808474665288);
        ...
        _delay(0x8345, 0x87a0);
        _setUpActor(USER2);
        Target.setDaoFee(199046721365560136679546864748434899760, 279597276851249199326873457644689719561);
        ...
        _setUpActor(USER3);
        Target.MAX_PRICE();
        _delay(0x1cae0, 0x3ed9);
        _setUpActor(USER3);
        Target.flashLoan(55, 62032579175917794029368281094692297847154095935808670395284557826830126214664, 146, 119);
        ...
        _delay(0x66815, 0x30cd);
        _setUpActor(USER3);
        Target.setDaoFee(1524785993, 1343992582);
        ...
        _delay(0x636fe, 0x87a0);
        _setUpActor(USER3);
        Target.setDaoFee(287955681794582478077375211925876011003, 221591575203100561124567032527343382920);
        ...
        _delay(0x62e05, 0xa475);
        _setUpActor(USER1);
        Target.flashLoan(
            3525638956377544751994761235366973011744329223394702748400921273412567412121,
            45888465482005145477466133910031818956778261338662610011639974285471802001863,
            255,
            255
        );
        ...
        _delay(0x42655, 0x2f15);
        _setUpActor(USER2);
        Target.withdrawFees(62);
        ...
        _delay(0x43af0, 0x47fd);
        _setUpActor(USER2);
        Target.withdrawFees(166);
        ...
        _delay(0x37272, 0xea4e);
        _setUpActor(USER3);
        Target.setDaoFee(284115480661695050735632880996372732059, 165137235197367492943249762141460252232);
