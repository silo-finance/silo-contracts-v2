...
contract CryticToFoundryDefaulting is Invariants, DefaultingHandler, SetupDefaulting {
    ...
    */
    ...
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(37422699887768669765783046586599516837044989231599567131519487622971353741226, RandomGenerator(255, 74, 255));
        _delay(0x8af1a, 0x320);
    _setUpActor(USER1);
        Target.increaseReceiveAllowance(346, 0, 5);
        _delay(0x142ef, 0x1740);
    _setUpActor(USER2);
        Target.liquidationCall(67728972471006198986298227812770245613331157852673164503068484645059995572823, false, RandomGenerator(160, 157, 255));
    ...
    _setUpActor(USER3);
        ...
        _delay(0x62e05, 0xff);
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(31012643420486718865104172824785518880978806563527511629903994531281080040044, RandomGenerator(114, 255, 197));
    ...
    _setUpActor(USER1);
        Target.transitionCollateral(115792089237316195423570985008687907853269984665640564039457584007913129639931, RandomGenerator(255, 190, 255));
        _delay(0x475d0, 0xa663);
    _setUpActor(USER1);
        Target.liquidationCallByDefaulting(102534336929198877321702095445937357962574072565302534037659811884723175914078, RandomGenerator(76, 83, 255));
    ...
    _setUpActor(USER2);
        ...
        _delay(0x4daf5, 0x20);
    _setUpActor(USER3);
        Target.liquidationCallByDefaulting(115792089237316195423570985008687907853269984665640564039457584007913129639935, RandomGenerator(255, 255, 255));
        _delay(0x3340a, 0x7f);
    _setUpActor(USER3);
        Target.accrueInterestForBothSilos();
        _delay(0x8dde9, 0x116e);
    _setUpActor(USER1);
        Target.receiveAllowance(29882650456281084738190043830201979887566836706330072603560922513535419521132, 228, 255, 204);
    ...
    _setUpActor(USER1);
        Target.liquidationCall(110342258604813883136076491391080051692563040975227526460641868343995084633246, false, RandomGenerator(12, 255, 255));
    ...
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(76597552767090721918719815898960607117313991696237260016271266784287660272610, RandomGenerator(87, 179, 255));
    ...
    _setUpActor(USER3);
        Target.liquidationCallByDefaulting(22219085446096088425086531464894483902672762533719580988545515823426312680099, RandomGenerator(255, 240, 255));
    ...
    _setUpActor(USER3);
        Target.increaseReceiveAllowance(115792089237316195423570985008687907853269984665640564039457584007913129639934, 255, 255);
        _delay(0x142ef, 0xd0cb);
    _setUpActor(USER3);
        Target.setReceiveApproval(115792089237316195423570985008687907853269984665640564039457584007913129639935, 172, 255);
    ...
    _setUpActor(USER3);
        ...
        _delay(0x6123, 0x320);
    _setUpActor(USER1);
        Target.setReceiveApproval(42433951474074729361621982518820040054100203943647270879125385874743773798748, 130, 24);
    ...
    _setUpActor(USER1);
        Target.increaseReceiveAllowance(61337461536744140313660380324818011942477261825176834788369124471526107825961, 255, 255);
    ...
    _setUpActor(USER2);
        Target.flashLoan(115792089237316195423570985008687907853269984665640564039457584007913129639934, 81056000941499040701568388718779561639595820402536415116979475732076940173524, 173, 255);
        _delay(0x75d98, 0x7f);
    _setUpActor(USER1);
    ...
    _setUpActor(USER3);
        Target.decreaseReceiveAllowance(115792089237316195423570985008687907853269984665640564039457584007913129639933, 0, 17);
        _delay(0x4a0f1, 0x26c0);
    _setUpActor(USER1);
        Target.setReceiveApproval(38619747731699152230644537703097785233519251829562314810378839206026474715870, 134, 255);
    ...
    _setUpActor(USER3);
        Target.liquidationCallByDefaulting(19440281052238228046917137526546382794030784465697728187592931051976865117079, RandomGenerator(43, 255, 0));
    ...
    _setUpActor(USER1);
        Target.liquidationCall(106723709733403423642092629950696877456986098004742726315960636427595273783252, true, RandomGenerator(156, 255, 195));
        _delay(0x142f0, 0x5caa);
    _setUpActor(USER1);
        Target.liquidationCallByDefaulting(41156989385870650511201598624304639187324262764121025257385690308482112243436, RandomGenerator(157, 255, 138));
        _delay(0x142ef, 0x7630);
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(66505786955507820238401180420926220756841145654195074064083144180067794290705, RandomGenerator(255, 255, 83));
        _delay(0x29247, 0x8ffb);
    _setUpActor(USER2);
        Target.setReceiveApproval(69826747835200643904221383016200815059410222286299230890513773756116249034947, 255, 119);
        _delay(0x804a4, 0xff);
    _setUpActor(USER3);
    ...
    _setUpActor(USER3);
        Target.receiveAllowance(88968095358741298776878563895436183321799220856386626409567278712462649867910, 255, 212, 255);
    ...
    _setUpActor(USER2);
        Target.transitionCollateral(21409319520113706690308350931635367003876811136146692412440777169173698490652, RandomGenerator(255, 255, 176));
        _delay(0x2621e, 0xb31c);
    _setUpActor(USER1);
        Target.setReceiveApproval(77337307715719400453942886950771053198709764232338099106449501237073269072113, 255, 255);
    ...
    _setUpActor(USER1);
        Target.setReceiveApproval(105048994818534055222674767794995888465534041843482300461275270909882071990677, 255, 222);
        _delay(0x142ee, 0x3c08);
    _setUpActor(USER2);
        Target.transferFrom(10193277817637005360558734678678705754054357859575678243450813619098131614745, 52, 244, 255);
    ...
    _setUpActor(USER1);
        Target.flashLoan(3525638956377544751994761235366973011744329223394702748400921273412567412121, 45888465482005145477466133910031818956778261338662610011639974285471802001863, 255, 255);
        _delay(0x94ab, 0x5b6b);
    _setUpActor(USER3);
        Target.MIN_PRICE();
        _delay(0x2a045, 0x5ef7);
    _setUpActor(USER2);
        Target.transferFrom(115792089237316195423570985008687907853269984665640564039457584007913129639935, 255, 255, 255);
        _delay(0x64ad5, 0xe8a0);
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(62642639977860731642902822164935719331006320956980023718404314800998625436649, RandomGenerator(62, 255, 253));
    ...
    _setUpActor(USER3);
        Target.liquidationCallByDefaulting(72142487059008203792313838954728895985149319951503394542868515209319545467410, RandomGenerator(231, 99, 179));
        _delay(0x52be8, 0x13bd);
    _setUpActor(USER2);
        Target.accrueInterestForSilo(247);
        _delay(0x214ca, 0x30cd);
    _setUpActor(USER2);
        Target.transitionCollateral(2905524548308743158965956862307356415408958468470663656910024000301346978550, RandomGenerator(255, 0, 99));
        _delay(0x307c6, 0x2e32);
    _setUpActor(USER3);
        Target.transitionCollateral(115792089237316195423570985008687907853269984665640564039457584007913129639935, RandomGenerator(255, 115, 206));
    ...
    _setUpActor(USER2);
        ...
        _delay(0x576ad, 0xd1ae);
    _setUpActor(USER1);
        Target.transferFrom(90318476213917949728386927160082259735316458568522904138088398235816897711407, 255, 255, 125);
    ...
    _setUpActor(USER3);
        Target.transferFrom(110083703931358221363076659603373759752367532300390439908929586863011616324167, 17, 252, 255);
    ...
    _setUpActor(USER1);
        Target.transitionCollateral(9185236013203816443548148432183170538667391471045253198729267642083338298609, RandomGenerator(255, 255, 229));
        _delay(0x6a2ce, 0xd13a);
    _setUpActor(USER3);
        Target.assert_LENDING_INVARIANT_B(20, 192);
        _delay(0x42655, 0x231);
    _setUpActor(USER1);
        Target.liquidationCallByDefaulting(83827132201277929604310278461769535334031346570138975986843818449008384355583, RandomGenerator(35, 255, 67));
        _delay(0x5617a, 0x1c9b);
    _setUpActor(USER1);
        Target.accrueInterest(255);
        _delay(0x3340a, 0x89b0);
    _setUpActor(USER1);
        Target.liquidationCall(115792089237316195423570985008687907853269984665640564039457584007913129639935, false, RandomGenerator(255, 255, 169));
        _delay(0x712e4, 0x9d0);
    _setUpActor(USER2);
        Target.liquidationCallByDefaulting(115792089237316195423570985008687907853269984665640564039457584007913129639935, RandomGenerator(255, 40, 64));
        _delay(0x43af0, 0xa663);
    _setUpActor(USER2);
        Target.transitionCollateral(5118569183195425567126660190276278917075707430839223737981446780898544030189, RandomGenerator(111, 255, 42));
        _delay(0x75d98, 0x769a);
    _setUpActor(USER2);
        Target.borrowShares(4370001, 150, 255);
        _delay(0x80772, 0xa4f5);
    _setUpActor(USER1);
        Target.receiveAllowance(15034577099901710996919593284599078084840332859386219662641994623747670967148, 112, 227, 11);
        _delay(0x4694f, 0xdcf6);
    _setUpActor(USER2);
        Target.MIN_PRICE();
        _delay(0x7cf4e, 0x9de);
    _setUpActor(USER3);
        Target.liquidationCallByDefaulting(22311278005040445027574342426498668344330648383954249661449739558162887707303, RandomGenerator(8, 255, 18));
        _delay(0xb056, 0x13bd);
    _setUpActor(USER1);
        Target.receiveAllowance(45850619002861701817056430916337683895700250925567096412401997802148956417440, 125, 255, 53);
        _delay(0x7f467, 0x20ff);
    _setUpActor(USER2);
        Target.assert_SILO_HSPOST_D(255);
        _delay(0x5eb90, 0x13be);
    _setUpActor(USER2);
        Target.transferFrom(90508370297569908360089741359687802433805485817034804351043343463550528335829, 191, 46, 70);
    ...
    _setUpActor(USER2);
        Target.liquidationCall(52143517035722306241620094494644035298324747384704421554497690072878146922462, true, RandomGenerator(230, 255, 255));
    ...
    _setUpActor(USER1);
        Target.liquidationCall(12534804810458885577279800138304601393139274961850757441096174455635091621820, true, RandomGenerator(255, 194, 255));
