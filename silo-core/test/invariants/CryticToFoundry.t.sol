...
contract CryticToFoundry is Invariants, Setup {
    ...
    function test_replay_transitionCollateral() public {
        ...
        Tester.borrowSameAsset(
            102750900109441762338823263821223164621313590537445587886855167060081089416903, 87, 135
        );
        _delay(427371);
        ...
        _delay(295513);
        Tester.borrowSameAsset(
            48064507900596314567628153981727950698207055150846498568362492192054574943706, 57, 11
        );
        _setUpActor(0x0000000000000000000000000000000000010000);
        _delay(295513);
        ...
        _delay(322274);
        Tester.borrowSameAsset(
            20147076027434589744787435822140337909775978096308948447385191221415469831626, 201, 225
        );
        _delay(322291);
        ...
        _delay(526880);
        Tester.borrowSameAsset(
            24900104684468280764509599872421672333601370005009598846076454071969943549876, 63, 175
        );
        _delay(190836);
        Tester.mint(115792089237316195423570985008687907853269984665640564039457559007913129639935, 202, 40, 19);
        _delay(490703);
    ...
    function test_replay_assert_BORROWING_HSPOST_D() public {
        ...
        _delay(411916);
        Tester.withdraw(
            115792089237316195423570985008687907853269984665640564039457584007910656676987, 104, 38, 135
        );
        _delay(62993);
