...
contract EchidnaE2E is Deployers, PropertiesAsserts {
    ...
    function _checkForInterest(Silo _silo) internal returns (bool noInterest) {
        (, uint64 interestRateTimestamp,,,) = _silo.getSiloStorage();
    ...
    function _dumpState(address _actor) internal {
        ...
        (uint256 collectedFees0, uint64 irmTimestamp0,,,) = vault0.getSiloStorage();
        (uint256 collectedFees1, uint64 irmTimestamp1,,,) = vault1.getSiloStorage();
