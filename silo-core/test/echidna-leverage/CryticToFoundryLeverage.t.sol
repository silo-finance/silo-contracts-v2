...
contract CryticToFoundryLeverage is InvariantsLeverage, SetupLeverage {
    ...
    */
    function test_EchidnaLeverage_flashLoan() public {
        ...
        LeverageTester.decreaseReceiveAllowance(2506243515399456898424707917941860539866995294705255171183520068680138867843,0,0);
        LeverageTester.setReceiveApproval(1913155963736077783573909335365462004495178792799802300617066144401103308184,12,0);
        ...
        LeverageTester.increaseReceiveAllowance(391973769657740080218754868106253814031280916767763404176632560007462046,0,0);
        ...
        LeverageTester.setReceiveApproval(507606517474450132998241132371234214242899071084181319930082545356247059019,7,0);
        LeverageTester.redeem(238061893215429977396790843149374670765627237310851972970105228488461581470,0,1,2);
        LeverageTester.assert_SiloLeverage_NeverKeepsTokens();
        LeverageTester.setReceiveApproval(345957942891661522125228166440086685362746088020517059088196480270243574166,0,1);
        LeverageTester.accrueInterest(0);
        LeverageTester.assert_LENDING_INVARIANT_B(0,16);
        LeverageTester.setReceiveApproval(311816311965755670072047901472851117588109351016112447432727435262343563314,0,0);
        LeverageTester.setReceiveApproval(281346305033155,0,0);
        LeverageTester.transferFrom(937338916035923317064455539115924757115701221115794661484537172102261420625,0,0,0);
        ...
        LeverageTester.setReceiveApproval(667276612231248455026895208616260496401399660543591216149552513214484200150,0,5);
        LeverageTester.setReceiveApproval(32859921402820668639879032312298514147236519854447112694477502761382976753453,92,2);
        ...
        LeverageTester.flashLoan(1,9300860518432582072233127002492206515438141778154890838101482432814708311882,4,18);
    }
}
