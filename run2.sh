# certoraRun.py certora/config/vaults/consistentState.conf --prover_version master
...
certoraRun.py certora/config/vaults/enabled.conf --prover_version master --rule isInDepositQThenIsInWithdrawQ --msg isInDepositQThenIsInWithdrawQ
...
# certoraRun.py certora/config/vaults/liveness.conf --prover_version master
...
# certoraRun.py certora/config/vaults/tokens.conf --prover_version master --rule onlySpecicifeidMethodsCanDecreaseMarketBalance
# certoraRun.py certora/config/vaults/timelock.conf --prover_version master