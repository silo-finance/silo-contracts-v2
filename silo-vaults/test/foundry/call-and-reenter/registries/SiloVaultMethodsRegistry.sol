...
import {SetSkimRecipientTest} from "../methods/SetSkimRecipientTest.sol";
...
import {SkimTest} from "../methods/SkimTest.sol";
...
contract SiloVaultMethodsRegistry is IMethodsRegistry {
    ...
    constructor() {
        ...
        _registerMethod(new SetSkimRecipientTest());
