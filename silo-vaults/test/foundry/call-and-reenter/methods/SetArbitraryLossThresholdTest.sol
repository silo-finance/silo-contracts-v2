...
contract SetArbitraryLossThresholdTest is MethodReentrancyTest {
    ...
    function methodDescription() external pure returns (string memory description) {
        description = "setArbitraryLossThreshold(address,uint256)";
    }
    ...
    function _ensureItIsProtected() internal {
        ...
        vault.setArbitraryLossThreshold(IERC4626(address(0)), 100e18);
    }
}
