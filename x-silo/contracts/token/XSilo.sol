 ...
 */
contract XSiloToken is Ownable, ReentrancyGuard, ERC20("Camelot escrowed token", "xGRAIL"), IXGrailToken {
    ...
    /// @dev Adjusted dividends rewards for redeeming xGRAIL, uses 2 decimals 100 == 100%
    /// eg. if set to 50, it will cut allocation to 50% of xToken amount that is going to be redeemed
    /// This is penalty for leaving the system.
    ...
    constructor(IGrailTokenV2 _siloTokenV2) {
        grailToken = _siloTokenV2;
