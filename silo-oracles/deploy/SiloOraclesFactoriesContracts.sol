...
library SiloOraclesFactoriesContracts {
    ...
    string public constant CUSTOM_CONVERSION_ORACLE_FACTORY = "CustomConversionOracleFactory.sol";
    ...
    string public constant FIXED_PRICE_PT_AMM_ORACLE_FACTORY = "FixedPricePTAMMOracleFactory.sol";
