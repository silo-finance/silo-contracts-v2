...
# certoraRun certora/config/vaults/tokenApproval.conf --msg notInWithdrawQThenNoApproval  
...
# certoraRun certora/config/vaults/tokens.conf --verify SiloVaultHarness:certora/specs/vaults/MarketBalance.spec --rule whoCanDecreaseTotalAssets --msg whoCanDecreaseTotalAssets --parametric_contracts SiloVaultHarness
# certoraRun certora/config/vaults/tokens.conf --verify SiloVaultHarness:certora/specs/vaults/TokensShares.spec --msg TokensShares --parametric_contracts SiloVaultHarness
certoraRun certora/config/vaults/tokens.conf --verify SiloVaultHarness:certora/specs/vaults/AssetsShares.spec --msg zeroAssetsZeroShares --parametric_contracts SiloVaultHarness --rule zeroAssetsZeroShares
