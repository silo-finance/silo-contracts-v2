...
// these rules check that sequences of method calls don't give free funds to the user
// (e.g. due to rounding)
...
rule HLP_Mint2RedeemNotProfitable(env e, address receiver)
{
    ...
    sharesToAssetsFixedRatio(e);
    //sharesToAssetsNotTooHigh(e, 2);
    //sharesAndAssetsNotTooHigh(e, 10^6);           // Didn't find it anywhere
...
// if there's a bug here, it means there's a bug in the real implementations
// if these hold, it DOESN'T verify the real implementations
