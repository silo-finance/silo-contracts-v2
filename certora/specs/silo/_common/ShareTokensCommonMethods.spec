methods {
    ...
    // function _.mint(address _owner, address _spender, uint256 _amount) external => DISPATCHER(true);
    ...
    // function _.burn(address _owner, address _spender, uint256 _amount) external => DISPATCHER(true);
}
