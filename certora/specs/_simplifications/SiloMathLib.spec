...
function sharesToAssetsApprox(
    ...
    return sharesMulDiv(_shares,totalAssets,totalShares,_rounding == Math.Rounding.Ceil);  //summ     from silo-core/contracts/lib/Rounding.sol: Math.Rounding internal constant UP = (Math.Rounding.Ceil);
...
function assetsToSharesApprox(
    ...
    return sharesMulDiv(_assets,totalShares,totalAssets,_rounding == Math.Rounding.Ceil);  //summ     from silo-core/contracts/lib/Rounding.sol: Math.Rounding internal constant UP = (Math.Rounding.Ceil);
