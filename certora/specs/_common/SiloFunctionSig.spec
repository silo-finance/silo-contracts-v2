...
definition depositWithTypeSig() returns uint32 = sig:deposit(uint256,address,ISilo.CollateralType).selector;
definition withdrawSig() returns uint32 = sig:withdraw(uint256,address,address).selector;
definition withdrawWithTypeSig() returns uint32 = sig:withdraw(uint256,address,address,ISilo.CollateralType).selector;
definition mintSig() returns uint32 = sig:mint(uint256,address).selector;
definition mintWithTypeSig() returns uint32 = sig:mint(uint256,address,ISilo.CollateralType).selector;
definition accrueInterestSig() returns uint32 = sig:accrueInterest().selector;
definition transitionCollateralSig() returns uint32 = sig:transitionCollateral(uint256,address,ISilo.CollateralType).selector;
...
definition redeemWithTypeSig() returns uint32 = sig:redeem(uint256,address,address,ISilo.CollateralType).selector;
